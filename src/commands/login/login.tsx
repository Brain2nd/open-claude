...
export function Login(props: {
  ...
  if (!oauthEnabled) {
    // OpenClaude: show API provider setup instead of OAuth when using
    // OpenRouter or other non-Anthropic base URLs.
    return (
      <OpenRouterSetup onDone={(key) => {
        props.onDone(!!key, mainLoopModel);
      }} />
    );
  }
