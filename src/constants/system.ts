...
const DEFAULT_PREFIX = `You are OpenClaude, an open-source AI coding assistant for the terminal.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are OpenClaude, an open-source AI coding assistant for the terminal, running within the Claude Agent SDK.`
